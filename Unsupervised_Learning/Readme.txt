In this folder, I will upload some of the amazing projects related to Unsupervised learning. 
------- Detail of the first project -----------
The first project is kind of cool, and compicated as well. The dataset is based on more than 500,000 rows. I have first cleaned the dataset, and then performed K-Mean clustering. For ease, I wrote description of the technical stuff beneath the code as well using text cell. 
